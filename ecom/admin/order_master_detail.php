				   ...
				   <div class="table-stats order-table ov-h">
					  <table class="table">
						...
						<div id="address_details">
							...
							<div>
								<form method="post" >
									<select class="form-control" name="update_order_status" required><br>
										<br><option value="">Select Status</option>
										<?php
									...
									<input type="submit" class="form-control btn-primary"/ onclick="updated()">
						           <script>
									   function updated(){
